...
export class CreateTable1731342386146 implements MigrationInterface {
    name = 'CreateTable1731342386146'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "title" character varying(255) NOT NULL, "content" text NOT NULL, "is_published" boolean NOT NULL DEFAULT false, "status" "public"."post_status_enum" NOT NULL DEFAULT 'pending', "is_draft" boolean NOT NULL DEFAULT true, "deleted_reason" text, "views" integer NOT NULL DEFAULT '0', "user_id" integer NOT NULL, "deleted_by_admin_id" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
