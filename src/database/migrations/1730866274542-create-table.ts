...
export class CreateTable1730866274542 implements MigrationInterface {
    name = 'CreateTable1730866274542'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "email" character varying, "password" text, "username" character varying NOT NULL, "avatar" text, "gender" "public"."user_gender_enum", "birth_date" date, "is_active" boolean NOT NULL DEFAULT false, "is_verified" boolean NOT NULL DEFAULT false, "is_published" boolean NOT NULL DEFAULT false, "provider" "public"."user_provider_enum" NOT NULL DEFAULT 'email', "facebook_id" character varying, "google_id" character varying, "refresh_token" text, "removed_reason" text, "removed_at" TIMESTAMP, "roleId" integer, "removedByAdminId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_189473aaba06ffd667bb024e71a" UNIQUE ("facebook_id"), CONSTRAINT "UQ_7adac5c0b28492eb292d4a93871" UNIQUE ("google_id"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_c55fb31646077481c3302554bf0" FOREIGN KEY ("removedByAdminId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_c55fb31646077481c3302554bf0"`);
